...
#+BEGIN_SRC emacs-lisp
  ...
  (defconst *is-a-win* (memq system-type '(cygwin windows-nt ms-dos)))
#+END_SRC
...
*** Empty scratch buffer and set major mode of the buffer
#+BEGIN_SRC emacs-lisp
  (setq initial-scratch-message "")
  (setq initial-major-mode 'org-mode)
#+END_SRC

*** Disable toolbar, menus and scrollbars
#+BEGIN_SRC emacs-lisp
(tool-bar-mode -1)
(menu-bar-mode 1)
(scroll-bar-mode -1)
...
*** Delete text when typing over selection
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;; From https://github.com/hrs/dotfiles/blob/master/emacs/.emacs.d/configuration.org
...
=goto-addr= is not a third-party package; it’s built into Emacs.
#+BEGIN_SRC emacs-lisp
  (use-package goto-addr
    ...
    :commands (goto-address-prog-mode
               goto-address-mode))
#+END_SRC
** Pass Mac system shell environment to Emacs
#+BEGIN_SRC emacs-lisp
...
=ggressive-indent-mode= is a minor mode that keeps your code always indented.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun writing-mode ()
    (interactive)
    (setq buffer-face-mode-face '(:family "dejavu sans mono" :height 200))
    (buffer-face-mode)
    (linum-mode 0)
    (writeroom-mode 1)
    (blink-cursor-mode)
...
** Python
*** Set python3 as default org-mode babel
#+BEGIN_SRC emacs-lisp
...
#+RESULTS:
| use-package | Cannot load hydra | :error | nil |

*** Scimax
#+BEGIN_SRC emacs-lisp :tangle no
  (setq scimax-dir "~/emacs_config/scimax")
  (add-to-list 'load-path "~/emacs_config/scimax")
  (require 'scimax-ob)
  ...
  ;; (add-to-list 'load-path (expand-file-name "org-ref" scimax-dir))
...
#+BEGIN_SRC emacs-lisp
  (when *is-a-mac*
      ...
      (let ((message-signature
	     (mu4e-read-option "Signature:"
				  ...
				  (concat
				   "Best Regards,\n"
				   "Marco Chiu\n"
				   "+852 6013 2727 | chiumarco@gmail.com\n"))
				 ("informal" .
				  (concat
				   "Thanks,\n"
				   "Marco\n"))))))
    ...
    (defun my-mu4e-key-binding ()
      "Run mu4e and close other frame"
      (interactive)
      (mu4e)
      (delete-other-windows))
  
    (global-set-key (kbd "<f6>") 'my-mu4e-key-binding))
#+END_SRC
...
[[http://kitchingroup.cheme.cmu.edu/blog/2016/10/29/Sending-html-emails-from-org-mode-with-org-mime/#orgheadline1][Sending html emails from org-mode with org-mime]]
#+BEGIN_SRC emacs-lisp
  (when *is-a-mac*
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-mobile-files (list path_home path_work path_personal path_inbox))
  (setq org-agenda-files (list path_home path_work path_personal path_inbox))
...
#+BEGIN_SRC emacs-lisp :tangle nos
  ...
  (use-package deft
    ...
    (setq deft-file-naming-rules
          '((noslash . "-")
            ...
            (case-fn . downcase)))
    (when *is-a-mac*
      (setq deft-directory "~/OneDrive/Documents/Org-mode"))
    (when *is-a-win*
      (setq deft-directory "C:/Users/Marco.Chiu/OneDrive/Documents/Org-mode")))
#+END_SRC
...
[[https://github.com/Wilfred/helpful][Helpful Github Link]]
#+BEGIN_SRC emacs-lisp
  (use-package helpful
    :ensure t
